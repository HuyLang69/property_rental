...
unset($__errorArgs, $__bag); ?>
                ...
                <label class="flex items-start gap-2.5 cursor-pointer select-none">
                    ...
                    <span class="text-sm text-[#5c5c5c] leading-snug">
                        I agree to the
                        <a href="<?php echo e(url('/terms')); ?>" class="text-[#111] hover:underline">Terms of Service</a>
                        and
                        <a href="<?php echo e(url('/privacy')); ?>" class="text-[#111] hover:underline">Privacy Policy</a>
                    </span>
                </label>
        ...
        <p class="text-center text-sm text-[#a8a8a8] mt-6">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-[#111] font-medium hover:underline">Log in</a>
        </p>

    </div>

</body>
</html><?php /**PATH C:\Users\User\Documents\GitHub\property-rental-laravel\property_rental\resources\views/register.blade.php ENDPATH**/ ?>