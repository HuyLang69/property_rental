<?php $__env->startSection('title', 'Admin Listings — NestAway'); ?>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    ...
                    <tr class="hover:bg-fog/30 transition-colors">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-12 h-12 rounded-xl bg-fog flex items-center justify-center shrink-0 overflow-hidden">
                                    <?php if($listing->coverImage): ?>
                                        <img src="<?php echo e(asset('storage/' . $listing->coverImage->path)); ?>" alt="" class="w-full h-full object-cover">
                                    <?php else: ?>
                                ...
                                <div>
                                    <p class="font-semibold text-ink line-clamp-1 truncate w-48" title="<?php echo e($listing->title); ?>"><?php echo e($listing->title); ?></p>
                                    <p class="text-xs text-silver mt-0.5"><?php echo e($listing->city); ?>, <?php echo e($listing->country); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-ink font-medium"><?php echo e($listing->host->full_name); ?></p>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <form action="<?php echo e(route('admin.toggleListing', $listing->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <button type="submit"
                                        ...
                                        <?php echo e($listing->is_available ? 'Hide' : 'Activate'); ?>

                                    </button>
                                </form>
                                <button type="button"
                                        onclick="openDeleteModal('del-listing-<?php echo e($listing->id); ?>')"
    ...
    <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div id="del-listing-<?php echo e($listing->id); ?>" class="fixed inset-0 z-50 hidden items-center justify-center px-4">
        <div class="absolute inset-0 bg-ink/40 backdrop-blur-sm"
             onclick="closeDeleteModal('del-listing-<?php echo e($listing->id); ?>')">
        </div>
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 flex flex-col gap-5">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate mt-1 leading-relaxed"><?php echo e(Str::limit($listing->title, 40)); ?></p>
            ...
            <div class="flex gap-3">
                ...
                <form action="<?php echo e(route('admin.destroyListing', $listing->id)); ?>" method="POST" class="flex-1">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\GitHub\property-rental-laravel\property_rental\resources\views/admin/listings.blade.php ENDPATH**/ ?>