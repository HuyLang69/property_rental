...
<div class="flex gap-1 mb-8 border-b border-fog">
    <a href="<?php echo e(route('dashboard.bookings')); ?>"
       class="px-4 py-2.5 text-sm font-medium transition-colors border-b-2 -mb-px
              <?php echo e(request()->routeIs('dashboard.bookings') ? 'border-ink text-ink' : 'border-transparent text-silver hover:text-ink'); ?>">
        My trips
    </a>
</div><?php /**PATH C:\Users\User\Documents\GitHub\property-rental-laravel\property_rental\resources\views/dashboard/_nav.blade.php ENDPATH**/ ?>