<?php $__env->startSection('title', 'All Listings — NestAway'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-silver mt-1"><?php echo e($listings->total()); ?> <?php echo e(Str::plural('property', $listings->total())); ?> found</p>
    </div>
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside class="w-full lg:w-64 shrink-0">
            <form action="<?php echo e(route('listings.index')); ?>" method="GET" class="flex flex-col gap-6 bg-white border border-fog rounded-2xl p-6 sticky top-24">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-2">
                        <?php $__currentLoopData = ['any' => 'Any', 'apartment' => 'Apartment', 'house' => 'House', 'studio' => 'Studio', 'villa' => 'Villa', 'room' => 'Room']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-2 text-sm text-slate cursor-pointer">
                            <input type="radio" name="type" value="<?php echo e($value === 'any' ? '' : $value); ?>" class="accent-ink"
                                <?php echo e(request('type', '') === ($value === 'any' ? '' : $value) ? 'checked' : ''); ?> />
                            <?php echo e($label); ?>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="beds" class="border border-fog rounded-xl px-3 py-2.5 text-sm text-ink bg-cream focus:border-ink focus:outline-none transition-colors">
                        ...
                        <option value="<?php echo e($n); ?>" <?php echo e(request('beds') == $n ? 'selected' : ''); ?>><?php echo e($n); ?>+</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="flex flex-col gap-2 pt-1 border-t border-fog">
                    ...
                    <a href="<?php echo e(route('listings.index')); ?>" class="w-full text-center text-sm text-silver hover:text-ink transition-colors py-1">
                        Clear all
                    </a>
                </div>
        ...
        <div class="flex-1">
            ...
            <div class="flex items-center justify-between mb-6">
                <p class="text-sm text-silver"><?php echo e($listings->total()); ?> results</p>
                <form action="<?php echo e(route('listings.index')); ?>" method="GET" id="sort-form">
            ...
            <?php if($listings->isEmpty()): ?>
                <div class="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <a href="<?php echo e(route('listings.index')); ?>" class="text-sm font-medium border border-fog rounded-full px-5 py-2 hover:border-ink transition-colors">Clear filters</a>
                </div>
            <?php else: ?>
                    ...
                    <a href="<?php echo e(route('listings.show', $listing->id)); ?>" class="lift group bg-white rounded-2xl overflow-hidden border border-fog flex flex-col">
                        ...
                        <div class="p-4 flex flex-col gap-2 flex-1">
                            <div class="flex items-start justify-between gap-2">
                                <div class="min-w-0">
                                    <h3 class="font-semibold text-sm text-ink truncate"><?php echo e($listing->title); ?></h3>
                            ...
                            <p class="text-xs text-slate"><?php echo e($listing->bedrooms); ?> bed<?php echo e($listing->bedrooms > 1 ? 's' : ''); ?> &middot; <?php echo e($listing->type); ?></p>
                            <p class="mt-auto text-sm font-bold text-ink">
                                $<?php echo e(number_format($listing->price_per_night / 100, 0)); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\GitHub\property-rental-laravel\property_rental\resources\views/listings/index.blade.php ENDPATH**/ ?>