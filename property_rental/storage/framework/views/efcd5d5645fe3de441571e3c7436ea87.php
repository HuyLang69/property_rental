<?php $__env->startSection('title', 'Incoming Bookings — NestAway'); ?>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <form method="GET" action="<?php echo e(route('host.bookings')); ?>"
        ...
        <select name="listing_id" onchange="this.form.submit()"
            ...
            <option value="<?php echo e($l->id); ?>" <?php echo e($listingFilter == $l->id ? 'selected' : ''); ?>>
                <?php echo e(Str::limit($l->title, 40)); ?>

            </option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>

        <?php if($status !== 'all' || $listingFilter): ?>
        ...
        <span class="text-xs text-silver ml-auto"><?php echo e($bookings->count()); ?> <?php echo e(Str::plural('booking', $bookings->count())); ?></span>
    </form>
    ...
    <?php else: ?>
        <div class="flex flex-col gap-4">
            ...
            <div class="bg-white border border-fog rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div class="flex items-start gap-4 flex-1 min-w-0">
                    ...
                    <div class="w-10 h-10 rounded-full bg-fog flex items-center justify-center text-xs font-semibold text-ink shrink-0">
                        <?php echo e(strtoupper(substr($booking->user->first_name, 0, 1))); ?><?php echo e(strtoupper(substr($booking->user->last_name, 0, 1))); ?>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="font-semibold text-ink text-sm">
                            <?php echo e($booking->user->first_name); ?> <?php echo e($booking->user->last_name); ?>

                        </p>
                        <p class="text-xs text-silver mt-0.5 truncate"><?php echo e($booking->listing->title); ?></p>
                ...
                <div class="flex flex-col items-start sm:items-end gap-3 shrink-0">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="button"
                                onclick="openModal('hmodal-<?php echo e($booking->id); ?>')"
            ...
            <?php if($booking->status !== 'cancelled'): ?>
            <div id="hmodal-<?php echo e($booking->id); ?>" class="fixed inset-0 z-50 hidden items-center justify-center px-4">
                <div class="absolute inset-0 bg-ink/40 backdrop-blur-sm"
                     onclick="closeModal('hmodal-<?php echo e($booking->id); ?>')"></div>
                <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 flex flex-col gap-5">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate mt-1 leading-relaxed">
                                <?php echo e($booking->user->first_name); ?> <?php echo e($booking->user->last_name); ?><br>
                    ...
                    <div class="flex gap-3">
                        <button type="button"
                                onclick="closeModal('hmodal-<?php echo e($booking->id); ?>')"
                        ...
                        <form action="<?php echo e(route('host.cancel', $booking->id)); ?>" method="POST" class="flex-1">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\GitHub\property-rental-laravel\property_rental\resources\views/host/bookings.blade.php ENDPATH**/ ?>