...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col lg:flex-row gap-12">
        ...
        <div class="flex-1 min-w-0">
            ...
            {{-- Quick facts --}}
            <div class="flex items-center flex-wrap gap-4 pb-8 border-b border-fog">
        ...
        <div class="w-full lg:w-80 xl:w-96 shrink-0">
            <div class="sticky top-24 bg-white border border-fog rounded-2xl p-6 shadow-sm">
                ...
                <form action="{{ url('/bookings') }}" method="POST" class="flex flex-col gap-4">
                    ...
                    <div class="border border-fog rounded-xl overflow-hidden">
                        <div class="grid grid-cols-2 divide-x divide-fog">
                            <div class="px-3 py-2.5">
                                ...
                                <input autocomplete="off" type="date" name="check_in" class="w-full text-sm text-ink bg-transparent focus:outline-none mt-0.5 cursor-pointer" required />
                            </div>
                            <div class="px-3 py-2.5">
                                <p class="text-[10px] uppercase tracking-widest text-silver font-medium">Check-out</p>
                                <input autocomplete="off" type="date" name="check_out" class="w-full text-sm text-ink bg-transparent focus:outline-none mt-0.5 cursor-pointer" required />
                            </div>
                        </div>
                ...
                <div class="mt-5 flex flex-col gap-2.5 pt-5 border-t border-fog text-sm">
